...
const SignUpPhase1 = ({ onNext, formData, setFormData }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (username.length < MIN_LENGTH)
      return setError(`Minimum ${MIN_LENGTH} characters required`);

    if (username.length > MAX_LENGTH)
      return setError(`Max ${MAX_LENGTH} characters allowed`);

    if (isAvailable === false)
      return setError("Username already taken");

    if (isAvailable !== true)
      return setError("Please wait for availability check");
    ...
    <div className="max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-44 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
            />
          ...
          <div className="mt-3">
            <div className="flex justify-between text-xs text-gray-500">
              ...
              {username.length < MIN_LENGTH && (
                <span>Min {MIN_LENGTH} chars</span>
              )}
            </div>
          ...
          {isAvailable === false && suggestions.length > 0 && (
            <div className="mt-3 p-3 bg-orange-50 border border-orange-200 rounded">
              <p className="text-sm font-medium text-orange-700 mb-2">
                Username Already Exits Try these instead:
              </p>
        ...
        <div className="p-4 bg-green-50 border border-green-200 rounded">
          <p className="text-sm">
            <b className="text-green-600">Your unique URL</b>
            <br />
            This will be your public creator page.
          </p>
        </div>
